...
<html lang="en">
  <head>
    ...
    <title>Educ8 Learning Management System - Student</title>
    <!-- plugins:css -->
...
<body>
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row" >
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center" style="background: #559E54">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center" style="background: #559E54">
		<ul class="navbar-nav">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            ?>
                ...
                <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/student/my_profile">My Profile<i class="dropdown-item-icon ti-dashboard"></i></a>
                <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/student/logout">Sign Out<i class="dropdown-item-icon ti-power-off"></i></a>
              </div>
            </li>
          </ul>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-image: linear-gradient(45deg, #92C591, #559E54 )">
          <ul class="nav">
			...
			<li class="nav-item">
              ...
              ?>
              <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>index.php/student/classes/<?php echo $CRow->id; ?>"><?php echo $CRow->class; ?></a>
               </li>
              <?php
             }
					 } 
				  ?>
          <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url(); ?>index.php/student/join_class">Join Class</a>
                  </li>
                </ul>
              </div>
            </li>
